...
if __name__ == "__main__":
	english_text= """GitHub Packages is a package hosting service, 
	...
	ലിവിങ്ങിലെ  അന്തേവാസികളായ മുതിര്‍ന്ന പൗരന്‍മാരുടെ സൃഷ്ടികളും പ്രദര്‍ശനത്തിലുണ്ട്.  
	കളിമണ്ണില്‍ തീര്‍ത്ത കലാസൃഷ്ടികളും പ്രദര്‍ശനത്തിന്‍റെ മറ്റൊരാകര്‍ഷണം. 
	നാലുമണിപൂക്കള്‍ എന്നു പേരിട്ട പ്രദര്‍ശനം ഞായറാഴ്ച വരെ നീളും.
	"""
